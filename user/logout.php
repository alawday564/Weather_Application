...
<head>
        <meta charset="utf-8" />
        <title>Weather_Application</title></title>
                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-center">
                                <p class="text-white-50">Back to <a href="sign_in.php" class="text-white ml-1"><b>Sign In</b></a>
                                    OR <a href="layout_basic.php" class="text-white ml-1"><b>HomePage</b></a></p>
                            </div>
                        </div>
                    </div>
                </div>
